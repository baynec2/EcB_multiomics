...
venn.diagram(
        x = list(both_sig, faecalis_sig, faecium_sig),
        category.names = c("E.facalis + E.faecium" , "E.faecalis " , "E.faecium"),
        filename = "../Manuscript/02_figures/f2_infection_v_healthy_proteomics/f2a-venn_diagram.svg",
        output=TRUE,
...
ggsave("03_supplemental/s2_networks_compared_to_healthy/up_ECB.pdf",up_ECB,height=11,width=8)
```
...
ggsave("03_supplemental/s2_networks_compared_to_healthy/down_EcB.pdf",down_EcB,height =11, width = 18)
```
##### Faecalis
...
ggsave("03_supplemental/s2_networks_compared_to_healthy/up_faecalis.pdf",up_faecalis,height=11,width=8)
```
...
ggsave("03_supplemental/s2_networks_compared_to_healthy/down_faecalis.pdf",down_faecalis,height=11,width=8)
```
...
ggsave("03_supplemental/s2_networks_compared_to_healthy/up_faecium.pdf",up_faecium,height=11,width=8)
```
...
# Extracting the uniprotids up in infected and shared
down_in_faecium = infected_vs_healthy_plot %>% 
  filter(log2FC <= 0) %>% 
  filter(color == "sig_in_faecium") %>% 
  # Going from Protein ID to gene ID
  left_join(protein_to_gene,by = c("uniprotid" = "ProteinID")) %>% 
  pull(Gene)
...
ggsave("03_supplemental/s2_networks_compared_to_healthy/down_faecium.pdf",down_faecium,height=11,width=8)
...
ggsave("03_supplemental/s2_networks_compared_to_healthy/up_staph.pdf",up_staph,height=11,width=8)
```
...
ggsave("03_supplemental/s2_networks_compared_to_healthy/down_staph.pdf",down_staph,height=11,width=8)
...
ggsave("02_figures/f2_infection_v_healthy_proteomics/f2b.pdf",height = 10, width = 12)
...
venn.diagram(
        x = list(enterococcus_sig, faecalis_sig, faecium_sig, staph_sig),
        category.names = c("EcB" , "E.faecalis " , "E.faecium","S. aureus"),
        filename = '02_figures/f2_infection_v_healthy_proteomics/up_in_infected_venn_diagram.png',
        output=TRUE,
...
venn.diagram(
        x = list(enterococcus_sig, faecalis_sig, faecium_sig, staph_sig),
        category.names = c("EcB" , "E.faecalis " , "E.faecium","S. aureus"),
        filename = '02_figures/f2_infection_v_healthy_proteomics/up_in_healthy_venn_diagram.png',
        output=TRUE,
...
## A- Unsupervised clustering of Proteomics and Metabolomic data combined
...
# Checking stats to see if there are significant differences between clusters when k=2
